...
Shader "Amazing Assets/Dynamic Wireframe Shader/Examples/Hologram/Lit (Dynamic Wireframe)"
{
Properties
{
...
void WireframeShaderDynamicMaskCone_float(float3 vertexPositionWS, float4x4 ShaderData, float Noise, out float Out)
{
...
float _WireframeRenderer_0178ed9bf9f34c738ce8b471c392c5bf_Wireframe_3_Float;
float2 _WireframeRenderer_0178ed9bf9f34c738ce8b471c392c5bf_BarycentricUV_4_Vector2;
WireframeRenderer_float(IN.uv3.xyz, max(0, _Property_1dc4788b9eca4069baa399efa4413298_Out_0_Float), max(0, _Property_8b57c7d9cbef4037966ba71e85a6a06c_Out_0_Float), 0, _WireframeRenderer_0178ed9bf9f34c738ce8b471c392c5bf_Wireframe_3_Float, _WireframeRenderer_0178ed9bf9f34c738ce8b471c392c5bf_BarycentricUV_4_Vector2);
float4x4 _Property_f395d9afd85d4bd78a5ad5dd80cc736e_Out_0_Matrix4 = _WireframeShaderMaskData;
float _DynamicMask_3f4fe165712441cbbefbc286027031fe_Out_3_Float;
WireframeShaderDynamicMaskCone_float(IN.WorldSpacePosition, _Property_f395d9afd85d4bd78a5ad5dd80cc736e_Out_0_Matrix4, float(0), _DynamicMask_3f4fe165712441cbbefbc286027031fe_Out_3_Float);
float _Multiply_b3cffbd67298456b992ab87b0e1b94d7_Out_2_Float;
Unity_Multiply_float_float(_WireframeRenderer_0178ed9bf9f34c738ce8b471c392c5bf_Wireframe_3_Float, _DynamicMask_3f4fe165712441cbbefbc286027031fe_Out_3_Float, _Multiply_b3cffbd67298456b992ab87b0e1b94d7_Out_2_Float);
...
UnityTexture2D _Property_6dd7819e424c402fb1716035e270a4c8_Out_0_Texture2D = UnityBuildTexture2DStructInternal(_MaskMap, sampler_MaskMap, _MaskMap_TexelSize, float4(1, 1, 0, 0), float4(0, 0, 0, 0));
...
if (_Property_6dd7819e424c402fb1716035e270a4c8_Out_0_Texture2D.hdrDecode.x > 0)
_SampleTexture2D_9bacd1d8d3194f1a909e0626a17f0a93_RGBA_0_Vector4 = DecodeHDRSample(_SampleTexture2D_9bacd1d8d3194f1a909e0626a17f0a93_RGBA_0_Vector4, _Property_6dd7819e424c402fb1716035e270a4c8_Out_0_Texture2D.hdrDecode);
...
float4 _Vector4_a323fdd57f844bd4b77bbbfbc3724586_Out_0_Vector4 = float4(_Property_7be0d2ff2c5f4926a7df4197b8a5a50b_Out_0_Float, _Property_7f3cbaed20da468c9673eedd1a7cdb21_Out_0_Float, float(0), _Property_e736e9327527475591515cc473446022_Out_0_Float);
...
/*ShaderGraphBody_Begin
{
    ...
    "m_Nodes": [
        ...
        {
            "m_Id": "f395d9afd85d4bd78a5ad5dd80cc736e"
        },
        {
        ...
        {
            "m_Id": "423f3e38466b454f897112a1b9138b4f"
        },
        {
            "m_Id": "5da57610940f4b77a10626f1f5be8027"
        },
        {
            "m_Id": "ff6276cce7e143c18733ab3f013131b6"
        },
        {
            "m_Id": "311ca672fab741cca44dbba14e01f793"
        },
        {
            "m_Id": "0178ed9bf9f34c738ce8b471c392c5bf"
        },
        {
            "m_Id": "3f4fe165712441cbbefbc286027031fe"
        }
    ],
    "m_GroupDatas": [
        {
    ...
    "m_Path": "Amazing Assets/Dynamic Wireframe Shader/Examples/Hologram",
    "m_GraphPrecision": 1,
    "m_PreviewMode": 2,
    "m_OutputNode": {
        "m_Id": ""
    ...
    "m_ActiveTargets": [
        {
            "m_Id": "aaa00837e3d9473aa14e7fc52987d864"
        }
    ]
}

{
    ...
    "m_ObjectId": "0125161913e24358a44a7ac4b54ef8cf",
    "m_Id": 0,
...

{
    ...
    "m_ObjectId": "0178ed9bf9f34c738ce8b471c392c5bf",
    "m_Group": {
        "m_Id": ""
    },
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -1658.1817626953125,
            "y": -145.74545288085938,
            "width": 315.9273681640625,
            "height": 164.94541931152345
        }
    },
    "m_Slots": [
        {
            "m_Id": "126183d94eab4df7a4d451b90de4d74c"
        },
        {
            "m_Id": "2f6d6f7caafa48be95cfec0c36243337"
        },
        {
            "m_Id": "0bca879ca879409984ac1995b12641d5"
        },
        {
            "m_Id": "b466af5eb7b3484fb8a11cd0550879eb"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Vector1MaterialSlot",
    "m_ObjectId": "0bca879ca879409984ac1995b12641d5",
    "m_Id": 3,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Vector1MaterialSlot",
    "m_ObjectId": "126183d94eab4df7a4d451b90de4d74c",
    "m_Id": 0,
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -423.27264404296877,
            "y": -41.01811981201172,
            "width": 132.654541015625,
            "height": 141.3817596435547
        }
    },
    "m_Slots": [
        {
...

{
    ...
    "m_ObjectId": "140499f778c6482b93b7c326f0e33e73",
    "m_Id": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Vector1MaterialSlot",
    "m_ObjectId": "187b75a5d72347dc846dfef5e999e1a4",
    "m_Id": 2,
    "m_DisplayName": "Noise",
    "m_SlotType": 0,
    "m_Hidden": false,
...

{
    ...
    "m_ObjectId": "18d9d1b6379f41bb82ba765328331aa7",
    "m_Id": 0,
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -975.7091064453125,
            "y": -115.19998168945313,
            "width": 137.01806640625,
            "height": 33.16364288330078
        }
    },
    "m_Slots": [
        {
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -1886.83642578125,
            "y": -109.09085083007813,
            "width": 186.763671875,
            "height": 33.16356658935547
        }
    },
    "m_Slots": [
        {
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Vector1MaterialSlot",
    "m_ObjectId": "2f6d6f7caafa48be95cfec0c36243337",
    "m_Id": 1,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.BlockNode",
    "m_ObjectId": "311ca672fab741cca44dbba14e01f793",
    "m_Group": {
        "m_Id": ""
    },
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": 9.599934577941895,
            "y": 261.81817626953127,
            "width": 199.85450744628907,
            "height": 40.14544677734375
        }
    },
    "m_Slots": [
        {
            "m_Id": "ab58acf1fe0b4f37b9a17b105302db5f"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    ...
    "m_ObjectId": "3f4fe165712441cbbefbc286027031fe",
    "m_Group": {
        "m_Id": ""
    },
    "m_Name": "Dynamic Mask",
    ...
    "m_Slots": [
        {
            "m_Id": "18d9d1b6379f41bb82ba765328331aa7"
        },
        {
            "m_Id": "ba66c6c48eab47438bbe5629945884f9"
        },
        {
            "m_Id": "187b75a5d72347dc846dfef5e999e1a4"
        },
        {
            "m_Id": "511376bade0d48318edeb234d74063cf"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.BlockNode",
    "m_ObjectId": "423f3e38466b454f897112a1b9138b4f",
    "m_Group": {
        "m_Id": ""
    },
    ...
    "m_Slots": [
        {
            "m_Id": "66bb553aa5674d8f82a68d0e18407af3"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Vector1MaterialSlot",
    "m_ObjectId": "511376bade0d48318edeb234d74063cf",
    "m_Id": 3,
    "m_DisplayName": "Out",
    "m_SlotType": 1,
    "m_Hidden": false,
...

{
    ...
    "m_ObjectId": "5b4c9a88ffd645619b17d128553219b1",
    "m_Id": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.BlockNode",
    "m_ObjectId": "5da57610940f4b77a10626f1f5be8027",
    "m_Group": {
        "m_Id": ""
    },
    ...
    "m_Slots": [
        {
            "m_Id": "5b4c9a88ffd645619b17d128553219b1"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.PositionMaterialSlot",
    "m_ObjectId": "66bb553aa5674d8f82a68d0e18407af3",
    "m_Id": 0,
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -801.1636352539063,
            "y": -154.47271728515626,
            "width": 184.14544677734376,
            "height": 155.3455047607422
        }
    },
    "m_Slots": [
        {
...

{
    ...
    "m_ObjectId": "82f97b418d6c474fa45c28ab165cbd0a",
    "m_WorkflowMode": 1,
    "m_NormalDropOffSpace": 0,
    "m_ClearCoat": false,
...

{
    ...
    "m_ObjectId": "aaa00837e3d9473aa14e7fc52987d864",
    "m_Datas": [],
    "m_ActiveSubTarget": {
        "m_Id": "82f97b418d6c474fa45c28ab165cbd0a"
    },
...

{
    ...
    "m_ObjectId": "ab58acf1fe0b4f37b9a17b105302db5f",
    "m_Id": 0,
...

{
    ...
    "m_ObjectId": "b466af5eb7b3484fb8a11cd0550879eb",
    "m_Id": 4,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.Matrix4MaterialSlot",
    "m_ObjectId": "ba66c6c48eab47438bbe5629945884f9",
    "m_Id": 1,
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            ...
            "x": -555.92724609375,
            "y": 720.8726196289063,
            "width": 132.65444946289063,
            "height": 117.81829833984375
        }
    },
    "m_Slots": [
        {
...

{
    ...
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -474.76361083984377,
            "y": 287.12725830078127,
            "width": 184.14544677734376,
            "height": 155.34548950195313
        }
    },
    "m_Slots": [
        {
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.PropertyNode",
    "m_ObjectId": "f395d9afd85d4bd78a5ad5dd80cc736e",
    "m_Group": {
        "m_Id": ""
    },
    "m_Name": "Property",
    "m_DrawState": {
        ...
        "m_Position": {
            "serializedVersion": "2",
            "x": -1886.83642578125,
            "y": 231.27273559570313,
            "width": 224.2908935546875,
            "height": 33.16363525390625
        }
    },
    "m_Slots": [
        {
            "m_Id": "140499f778c6482b93b7c326f0e33e73"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
...

{
    "m_SGVersion": 0,
    "m_Type": "UnityEditor.ShaderGraph.BlockNode",
    "m_ObjectId": "ff6276cce7e143c18733ab3f013131b6",
    "m_Group": {
        "m_Id": ""
    },
    ...
    "m_Slots": [
        {
            "m_Id": "0125161913e24358a44a7ac4b54ef8cf"
        }
    ],
    "synonyms": [],
    "m_Precision": 0,
